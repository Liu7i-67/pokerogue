...
const pressAction = i18next.t("setting:assignTips");
...
export const settingKeyboardOptions = {
  ...
  [SettingKeyboard.Button_Submit]: [
    `KEY ${Button.SUBMIT.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Down]: [
    `KEY ${Button.DOWN.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Left]: [
    `KEY ${Button.LEFT.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Right]: [
    `KEY ${Button.RIGHT.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Action]: [
    `KEY ${Button.ACTION.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Button_Cancel]: [
    `KEY ${Button.CANCEL.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Cancel]: [
    `KEY ${Button.CANCEL.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Menu]: [
    `KEY ${Button.MENU.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Button_Stats]: [
    `KEY ${Button.STATS.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Stats]: [
    `KEY ${Button.STATS.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Button_Cycle_Form]: [
    `KEY ${Button.CYCLE_FORM.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Cycle_Form]: [
    `KEY ${Button.CYCLE_FORM.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Button_Cycle_Shiny]: [
    `KEY ${Button.CYCLE_SHINY.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Cycle_Shiny]: [
    `KEY ${Button.CYCLE_SHINY.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Button_Cycle_Gender]: [
    `KEY ${Button.CYCLE_GENDER.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Cycle_Gender]: [
    `KEY ${Button.CYCLE_GENDER.toString()}`,
    pressAction,
  ],
  ...
  [SettingKeyboard.Button_Cycle_Nature]: [
    `KEY ${Button.CYCLE_NATURE.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Cycle_Nature]: [
    `KEY ${Button.CYCLE_NATURE.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Button_Cycle_Variant]: [
    `KEY ${Button.V.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Cycle_Variant]: [
    `KEY ${Button.V.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Button_Speed_Up]: [
    `KEY ${Button.SPEED_UP.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Speed_Up]: [
    `KEY ${Button.SPEED_UP.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Button_Slow_Down]: [
    `KEY ${Button.SLOW_DOWN.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Slow_Down]: [
    `KEY ${Button.SLOW_DOWN.toString()}`,
    pressAction,
  ],
  [SettingKeyboard.Alt_Button_Submit]: [
    `KEY ${Button.SUBMIT.toString()}`,
    pressAction,
  ],
};
    ...
    if (value) {
      if (scene.ui) {
        const cancelHandler = (success: boolean = false): boolean => {
          scene.ui.revertMode();
          (
              scene.ui.getHandler() as SettingsKeyboardUiHandler
          ).updateBindings();
          return success;
        };
